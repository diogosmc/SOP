...
from app.modules.chat.schemas import ChatMessageRequest, ChatMessageResponse, ChatSessionResponse
...
async def list_session_messages(
    ...
    service = ChatService(db)
    return APIResponse(data=await service.list_messages(session_id, user_id))
